...
<m-navbar :theme="theme.theme.headerTheme">
  ...
  <m-nav align="right">
    <m-nav-item padding="0">
      <m-dropdown align="right" v-if="userInfo" padding="0 10px">
        <a href="#" style="display: inline-block; padding: 0px; color: inherit">
          <img :src="imgUrl + userInfo.avatar" alt="" style="border-radius: 3px;vertical-align: middle;width: 30px;height: 30px;">
          <span>{{userInfo.nickName}}</span> 
          <span class="caret"></span>
        </a>
        <m-dropdown-panel>
          <m-dropdown-item name="update-pwd">修改密码</m-dropdown-item>
